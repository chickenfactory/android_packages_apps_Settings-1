...
public class DensityChanger extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.crdroid_density);
        ...
        mDpiMarket = findPreference("dpi_market");
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mCustomDensity) {
            ...
            return true;
        } else if (preference == mDpiMarket) {
            Uri uri = Uri.parse("http://forum.xda-developers.com/showthread.php?t=1839871");
